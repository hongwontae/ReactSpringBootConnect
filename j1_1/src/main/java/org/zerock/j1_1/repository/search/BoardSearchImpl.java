...
import org.zerock.j1_1.domain.QBoard;
import org.zerock.j1_1.domain.QReply;
...
public class BoardSearchImpl extends QuerydslRepositorySupport implements BoardSearch{
  ...
  @Override
  public PageResponseDTO<BoardListRCountDTO> searchDTORcnt(PageRequestDTO requestDTO) {
    ...
    JPQLQuery<BoardListRCountDTO> listQuery = query.select(
      Projections.bean(BoardListRCountDTO.class, 
        board.bno,
        board.title,
        board.writer,
    ...
    List<BoardListRCountDTO> list = listQuery.fetch();    
